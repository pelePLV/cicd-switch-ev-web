import { getBatteryTransactions } from '@/lib/api/get-battery-transactions';
...
export const useBatteryTransaction = (
  ...
  const queryResult = useQuery({
    queryKey: ['batteryTransactions', queryParams],
    queryFn: () => getBatteryTransactions(queryParams),
  });
