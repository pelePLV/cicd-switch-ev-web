...
import { getBatteryTransactionsByUser } from '@/lib/api/get-battery-transactions-by-user';

export const useBatteryTransactionByUser = (
  userId: string,
  ...
  const queryResult = useQuery({
    queryKey: [`batteryTransactionsByUser/${userId}`, queryParams],
    queryFn: () => getBatteryTransactionsByUser(userId, queryParams),
  });
